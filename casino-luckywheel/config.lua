...
Config.startingPrice = 15000 -- How much it costs a player to spin the wheel, if LimitedSpins is set to false
Config.VehiclePrize = 'xa21' -- The prize vehicle
Config.VehicleSpawnCoords = vector4(933.29, -2.82, 78.76, 144.6)
Config.VehiclePlateText = 'd07ry'



Config.LimitedSpins = true			-- [true = players spin once per day for free] [false= $5000 a spin]
Config.LimitedSpinResetTime = '00:00' 	-- 24 hour clock
...
Config.Prices = {
	...
	[12] = {type = 'item', 		name = 'casino_chip', 		count = 15000, 	sound = 'chips', 	probability = {a = 300, b = 340}},	--  6.0 %  34.0 -- 15.000 chips
	...
	[16] = {type = 'item',		name = 'casino_chip', 		count = 10000, 	sound = 'chips', 	probability = {a = 610, b = 640}},	--  8.0 %  64.0 -- 10.000 chips
	...
	[19] = {type = 'item', 		name = 'cola', 				count = 1, 		sound = 'clothes', 	probability = {a = 810, b = 990}},	--  9.0 %  90.0 -- CLOTHING
